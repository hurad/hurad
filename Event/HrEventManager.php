 ...
 * @see CakeEventManager
 */
class HrEventManager extends CakeEventManager {
    ...
    /**
     * Returns the globally available instance of a HrEventManager
     * @return HrEventManager the global event manager
     */
    public static function instance($manager = null) {
        if (empty(self::$_generalManager)) {
            return parent::instance(new HrEventManager());
        }
