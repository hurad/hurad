(function ($) {
    ...
    function check_pass_strength() {
        var pass1 = $('#UserPassword').val(), user = $('#UserUsername').val(), pass2 = $('#UserConfirmPassword').val(), strength;
        ...
        switch (strength) {
            ...
            case 5:
                ...
                break;
            default:
                $('#pass-strength-result').addClass('short').html(pwsL10n['shortly']);
        }
    }

    $(document).ready(function () {
        $('#UserPassword').val('').keyup(check_pass_strength);
        $('#UserConfirmPassword').val('').keyup(check_pass_strength);
