        ...
        <div class="col-md-8">
            ...
            <div class="control-group">
                <div class="controls">
                    <?php echo $this->Form->input(
                        'slug',
                        array('type' => 'text', 'class' => 'col-md-12 postSlug', 'placeholder' => __d('hurad', 'Enter slug here'))
                    ); ?>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="portlet">
                    ...
                    <div class="portlet-content publish-widget">
                        <ul class="unstyled">
                            ...
                            <li class="text-right">
                                ...
                                <?php echo $this->Form->month(
                                    'created',
                                    array('empty' => false, 'class' => 'input-sm', 'value' => date('m'))
                                ); ?>
                        ...
                        <div class="hr-form-actions">
                            <?php echo $this->Form->submit(__d('hurad', 'Update'), array('class' => 'btn btn-primary')) ?>
                        </div>
                    </div>
                </div>
                <div class="portlet">
