        ...
        <div class="control-group">
            <div class="controls">
                ...
                echo $this->Form->input('slug', array(
                    ...
                    'value' => Formatting::esc_attr($this->Hook->apply_filters('editable_slug', $post['Post']['slug']))
                        )
                );
                ?>
            </div>
                ...
                <div class="portlet-content publish-widget">
                    <ul class="unstyled">
                        ...
                        <li class="text-center">
                            <?php echo $this->Html->tag('span', __('Hour: '), array('class' => 'hr-control-label')); ?> <?php echo $this->Form->hour('created', TRUE, array('empty' => false, 'class' => 'input-mini')); ?>
                            <?php echo '<b> : </b>'; ?>
                            <?php echo $this->Form->minute('created', array('empty' => false, 'class' => 'input-mini')); ?><?php echo $this->Html->tag('span', __('Minute'), array('class' => 'hr-control-label-minute')); ?>
                        </li>
                        <li class="divider"></li>
                    </ul>
