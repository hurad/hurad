...
<div class="control-group <?php echo $this->AdminLayout->isFieldError('General.admin_email', $errors) ? 'error' : ''; ?>">
...
<div class="control-group">
    ...
    <div class="controls">
        <?php
        echo $this->Form->input('default_role', array(
            'options' => array(
                'user' => __('User'),
                'author' => __('Author'),
                'editor' => __('Editor'),
...
<div class="control-group">
    ...
    <div class="controls">
        <?php
        echo $this->Form->input('time_format', array(
            'options' => array(
