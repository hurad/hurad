...
<div id="respond">
    <h3 id="reply-title">Leave a Reply
        <small><a style="display:none;" href="/demo/testing-this-theme-with-more-posts.php#respond"
                  id="cancel-comment-reply-link" rel="nofollow">Cancel</a></small>
    </h3>
    <?php
    ...
    <p class="comment-form-email">
        <input type="text" class="required email" size="30" value="" name="email" id="email"><label for="email">Your
            Email</label> <span class="required">*</span>
    </p>

    <p class="comment-form-url"><input type="text" size="30" value="" name="url" id="url"><label for="website">Your
            Website</label></p>

    <p class="comment-form-comment"><textarea class="required" aria-required="true" rows="8" cols="45" name="comment"
