...
<table class="form-table">
    <tbody>
        ...
        <tr class="form-field">
            <th scope="row"><?php echo $this->Form->label('parent_id', __('Parent Category')); ?></th>
            <td>
                <?php echo $this->Form->select('parent_id', $parentCategories, array('empty' => __('None'))); ?>
                <p><?php echo __('Categories, unlike tags, can have a hierarchy. You might have a Jazz category, and under that have children categories for Bebop and Big Band. Totally optional.'); ?></p>
            </td>
        </tr>        
        <tr class="form-field">
...
<?php echo $this->Form->input(__('Add Category'), array('type' => 'submit', 'class' => 'add_button')); ?>
