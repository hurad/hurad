...
<div class="control-group">
    <?php echo $this->Form->label('parent_id', __('Parent Category'), array('class' => 'control-label')); ?>
    <div class="controls">
        <?php echo $this->Form->select('parent_id', $parentCategories, array('empty' => __('None'))); ?>
        <span class="help-block">
            <?php echo __('Categories, unlike tags, can have a hierarchy. You might have a Jazz category, and under that have children categories for Bebop and Big Band. Totally optional.'); ?>
        </span>
    </div>
</div>
<div class="control-group">
