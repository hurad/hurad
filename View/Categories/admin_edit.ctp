        ...
        <table class="form-table">
            <tbody>
                <tr class="form-field form-required">
                    <th scope="row"><?php echo $this->Form->label('parent_id', __('Parent Category')); ?> <span class="description"><?php echo __("(Required)"); ?></span></th>
                    <td><?php echo $this->Form->select('parent_id', $parentCategories, array('empty' => 'Nothing')); ?></td>
                </tr>
                <tr class="form-field form-required">
