<?php foreach ($pages as $page): ?>
    ...
    <article id="post-<?php $this->Page->the_ID(); ?>" class="post-<?php $this->Page->the_ID(); ?> post type-post status-publish format-standard hentry category-motion-design tag-home tag-motion-design post clearfix ">
        ...
        <time datetime="<?php $this->Page->the_date('Y-m-d H:i:s'); ?>" class="post-date"><?php $this->Page->the_date(); ?></time>
        <h1 class="post-title"><a href="<?php $this->Page->the_permalink(); ?>" title="<?php printf(__( 'Permalink to %s' ), $this->Page->the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php $this->Page->the_title(); ?></a></h1>
        <p class="post-meta"> 
