...
<table class="list-table">
    ...
    <?php foreach ($links as $link): ?>
        <tr id="<?php echo h($link['Link']['id']); ?>" class="link-<?php echo h($link['Link']['id']); ?>">
            ...
            <td class="column-url">
                <?php echo $this->Html->link($this->Layout->linkUrl($link['Link']['url']), $link['Link']['url'], array('target' => '_blank', 'title' => __('Visit %s', $link['Link']['name']))); ?>
            </td>
            <td class="column-menu">
                <?php echo h($link['Menu']['name']); ?>&nbsp;
            </td>
            <td class="column-visible">
                <?php echo $this->Layout->linkVisible($link['Link']['visible']); ?>
            </td>
